...
//! `WebDavBackend` from `oxcrypt-webdav`. Otherwise, it provides a stub
...
//!
//! ```bash
//! cargo build -p oxcrypt-desktop --features webdav
//! ```

// When the webdav feature is enabled, re-export from oxcrypt-webdav
#[cfg(feature = "webdav")]
