...
use oxcrypt_core::vault::{DirId, VaultCreator, VaultOperations, VaultWriteError};
...
fn test_vault_creator_reopen_with_password() {
    use oxcrypt_core::vault::extract_master_key;
...
use oxcrypt_core::vault::VaultOperationError;
